package Lab_2;// This file contains the main() function for the Scheduling
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                if (line.startsWith("process")) {
                    ...
                    } while (cputime <= ioblocking);

                    processVector.addElement(new sProcess(cputime, ioblocking, 0, 0, 0, index));
                    index++;
                }
